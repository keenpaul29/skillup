...
import SkillUpForm from "../custom/SkillUpForm"; // Import the SkillUpForm component
...
const Header = () => {
  ...
  return (
    <>
      ...
      <div
        ...
        <div className="w-full flex items-center justify-between h-full">
          ...
          <div className="w-full h-full hidden lg:flex items-center justify-end gap-6 px-4 text-base">
            ...
            <NavLink to="/admin" className="font-normal">Admin Panel</NavLink> {/* Link to Admin Panel */}
            <div onClick={() => setIsModalOpen(true)}> {/* Open modal on click */}
      ...
      <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}> {/* Render Modal */}
        <SkillUpForm /> {/* Assuming SkillUpForm is the form to be displayed */}
      </Modal>
    </>
  );
};
